Prefer aliased imports like `#styles/main.css`.
Only create abstractions for fundamentals. Prefer frameworks and libraries over custom abstractions.
Avoid splitting code into private functions. Inline and specialize behavior where practical.
